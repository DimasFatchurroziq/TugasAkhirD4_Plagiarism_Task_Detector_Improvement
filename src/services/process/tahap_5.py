from src.infrastructures.similarity.similarity import jaccard_similarity, containment_similarity
from src.infrastructures.rkr_gst.remove_contained import remove_contained
...
class Tahap_5:
    ...
    def similarity(self, tiles_list, length_1, length_2):
        ...
        # tiles_list = gst_right_left(sort_matched_list, rollinghash_list_1, rollinghash_list_2, min_match_len=3)
