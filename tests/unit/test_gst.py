...
def test_gst_basic_case():
    ...
    hasil = gst_right_left(sort_matched_list, indexing_list_a, indexing_list_b, min_match_len=3)
...
def test_gst_no_match():
    ...
    hasil = gst_right_left(sort_matched_list, list_a, list_b, min_match_len=3)
    assert hasil == ([], 2, 2)
...
def test_gst_basic_case_1():
    ...
    hasil = gst_right_left(matched_list, indexing_list_a, indexing_list_b, min_match_len=3)
...
def test_gst_multiple_tiles():
    ...
    hasil = gst_right_left(matched, list_a, list_b, min_match_len=2)
